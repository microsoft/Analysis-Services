...
namespace BismNormalizer.TabularCompare
{
    ...
    /// </summary>
    public enum ValidationMessageType { Model, DataSource, Table, Relationship, Measure, Kpi, CalculationGroup, CalculationItem, Perspective, Culture, Role, Expression, Function, Action, MeasureCalculationDependency, AggregationDependency, General }; //General used for command line only
    ...
    /// </summary>
    public enum ComparisonObjectType { Model, DataSource, Table, Relationship, Measure, Kpi, CalculationItem, Perspective, Culture, Role, Expression, Function, Action, Connection }; //Need connection for backwards compatibility when deserializing from xml. Set to data source.
